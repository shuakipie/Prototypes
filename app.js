...
String.prototype.yell = function() {
	...
	return `WOW!!! ${this.toUpperCase()} !!!!! AGGHGHHGG`
	
	
} 
const yam = "SHUAKIPIE"
console.log(yam.yell())// to call the function on the prototype

Array.prototype.pop = function () {
	
		return "SORRY I WANT THAT ELEMENT, I WILL NEVER POP IT OFFF"
